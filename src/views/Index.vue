        ...
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            <h2 class="font-semibold text-4xl text-blueGray-600">
              Sumar2 - Get Started your Work from here
            </h2>
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
              Sumar2 is a cutting-edge website developed by the talented duo
              Umar and Sanwal. Combining their expertise in web development,
              they have crafted a user-friendly and innovative platform that
              stands out in functionality and design. Explore more about
              <a
              ...
              work and projects in his portfolio.
            </p>
            <div class="mt-12">
              <a
                href="https://github.com/sanwalsulehri"
                target="_blank"
              ...
              <a
                href="https://github.com/sanwalsulehri/sumar2-vue"
                ...
                <div class="relative flex flex-col mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      Sumar2 comes with a huge number of Fully Coded CSS
                      components.
                    </p>
                  </div>
                </div>
      ...
      <div class="container mx-auto overflow-hidden pb-20">
        <div class="flex flex-wrap items-center">
          <div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
            ...
            <a
              href="https://github.com/sanwalsulehri?tab=repositories"
              target="_blank"
      ...
      <div class="justify-center text-center flex flex-wrap mt-24">
        <div class="w-full md:w-6/12 px-12 md:px-4">
          ...
          <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
            Sumar2 is a completly new product built using our past experience in
